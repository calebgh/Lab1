...
def get_stats():
  ...
  return jsonify({"Chicken": chicken,"Computer Science (Major)": csm , "Computer Science (Special)": css, "Fish": fish, "Information Technology (Major)": itm, "Information Technology (Special)": its, "Vegetable": vege })
